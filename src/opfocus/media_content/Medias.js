...
function Medias() {
  ...
  if (language !== 'en') {
    ...
    },
    {
      ...
      description: 'OP官方文章翻译至中文。subli乐观通讯翻译至中文。（中文）'
    },
    {
      _id: '003',
    ...
    },
    {
      ...
      description: "不断更新治理线索，在交易层面详细说明前两个赛季治理基金发生给项目后的情况。（英语）"
    },
    {
      _id: '006',
      logo_img: 'images/op_logo.svg',
      chain_logo_img: 'images/op_logo.svg',
      title: 'The Optimism Collective官方Blog',
      link: 'https://optimism.mirror.xyz/',
      description: "扩展以太坊为其未来提供资金。（英语）"
    },
    {
      _id: '007',
      ...
      description: "由 Coinbase 孵化并建立在开源 OP Stack 之上的以太坊 L2。我们没有发行新代币的计划。（英语）"
    },
    {
      _id: '008',
